      ...
      <div className="max-w-7xl mx-auto flex px-5 pt-[120px] md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-40 items-center text-center">
          ...
          <p className="mb-4 xl:w-3/4 text-gray-600 text-xl">
            Welcome to Tyagi Care Center, where compassionate care meets medical
            excellence. Founded by <b>Dr. Mimansa Tyagi</b>, our clinic is dedicated to
            ...
            in a warm and welcoming environment. At Tyagi Care Center, we
