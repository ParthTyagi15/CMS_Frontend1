      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            Dr. Mimansa Tyagi always dreamt of creating a space where patients
            ...
            Tyagi established Tyagi Care Center in 2024, aiming to bridge the
          ...
          <p className="mb-8 leading-relaxed">
            ...
            symptoms. Dr. Tyagi's unwavering commitment to excellence, combined
            with a team of skilled healthcare professionals, has made Mimansa
